...
func (_m *mockteamsClient) SendWithContext(ctx context.Context, webhookURL string, webhookMessage goteamsnotify.TeamsMessage) error {
...
//   - ctx context.Context
//   - webhookURL string
//   - webhookMessage goteamsnotify.TeamsMessage
...
func (_c *mockteamsClient_SendWithContext_Call) Run(run func(ctx context.Context, webhookURL string, webhookMessage goteamsnotify.TeamsMessage)) *mockteamsClient_SendWithContext_Call {
